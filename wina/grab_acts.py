...
parser.add_argument('--model_name', type=str, requries=True,help='Path of the model to use')
parser.add_argument('--output_path', type=str, requries=True, help='Path to the output')
